        ...
        <>
            <section className="trabajos" id="trabajos">
                <div className="encabezado">
                    ...
                    <p className="subtitulo">Me encanta usar mi creatividad para desarrollar proyectos unicos de alto impacto.</p>
                </div>
                <div className="filtros">
                    ...
                    <input type="radio" name="categoria" id="branding-e-identidad-visual" onChange={handleChange} checked={categoriaSelecionada === 'branding-e-identidad-visual'}/>
                    <span className="opcion">Branding e Identidad Visual</span>
                    </label>

                    <label htmlFor="creatividad-visual-y-conceptualización" onChange={handleChange} checked={categoriaSelecionada === 'creatividad-visual-y-conceptualización'}>
                    <input type="radio" name="categoria" id="creatividad-visual-y-conceptualización"/>
                    <span className="opcion"> Creatividad Visual y Conceptualización</span>
                    </label>

                    <label htmlFor="ux-y-diseño-editorial">
                    <input type="radio" name="categoria" id="ux-y-diseño-editorial" onChange={handleChange} checked={categoriaSelecionada === 'ux-y-diseño-editorial'}/>
                    <span className="opcion">UX y Diseño Editorial</span>
                    </label>

                    <label htmlFor="otros">
                    <input type="radio" name="categoria" id="otros" onChange={handleChange} checked={categoriaSelecionada === 'otros'}/>
                    <span className="opcion">Otros</span>
                    </label>
                </div>
                <div className="grid">
